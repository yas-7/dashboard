module.exports = {
  up: async (queryInterface) => {
    const authors = await queryInterface.sequelize.query('SELECT id from Authors;', { type: queryInterface.sequelize.QueryTypes.SELECT });
    const websites = await queryInterface.sequelize.query('SELECT id from Websites;', { type: queryInterface.sequelize.QueryTypes.SELECT });
